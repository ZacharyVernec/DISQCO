...
python "$HOME/main.py" #--input /path/to/data --output "$SLURM_TMPDIR/results.csv"
...
echo "--- Copying data to home ($HOME) ---"
cp -v "$SLURM_TMPDIR/results-data-{gcp-s,gcp-e,fgp-roee,mlfm-r,zv-thy,pytket-de,pytket-aesd}.txt" "$HOME"
